...
const ProjectsPageHeader = () => {
  return (<section className="relative bg-foreground overflow-hidden flex items-center justify-center md:rounded-b-[32px]">
    <ResponsiveImage
        src="/images/projects-hero-bg/projects-hero-bg-375.webp"
        path="/images/projects-hero-bg"
        fileName="projects-hero-bg"
        fileExtension="webp"
    ...
    <div className="relative z-10 overflow-hidden gap-7 max-w-300 mx-auto flex flex-col pt-40 md:pt-33 lg:pt-43 xl:pt-50 pb-43 md:pb-25 lg:pb-27 px-3 sm:px-6 xl:px-0">
      ...
      <div className="space-y-5 mx-auto">
        <p className="leading-normal text-secondary-foreground text-lg md:text-xl font-nomediumrmal text-center">Want a custom solution?</p>
